 ...
 * @name postPing
 * @path {POST} /api/pinecone/getIndex
 * @description Bussiness Logic :- In getIndex API, we are getting the description of an index in pinecone
...
const index = async (req, res) => {
  try {
    const index = await Pinecone.getIndex(req.body.indexName)
...
router.post('/getIndex', validation, index)
