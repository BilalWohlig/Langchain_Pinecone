...
const relevantContexts = async (req, res) => {
  try {
    const data = await Pinecone.getRelevantContexts(req.body.indexName, req.body.question)
...
router.post('/getRelevantContexts', validation, relevantContexts)
